...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "HelloPrinter"
...
#define THERMAL_RUNAWAY_PROTECTION_BED_PERIOD 10 //in seconds
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,1100}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1200,1200,100,300}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
